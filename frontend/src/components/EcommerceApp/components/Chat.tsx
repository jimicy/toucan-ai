...
function PopularItemsAnalysisMessage(props: {
  data: PopularItemAnalysis;
  ...
  return (
    <>
      ...
      <div style={{ marginBottom: 20 }}>
        <Typography paragraph>
          Your products are sorted by numbers sold
          <br />
          1. For each of them, count all the customers to figure out the most
          popular age bucket.
          <br />
          2. For the top 3 products and their popular age buckets we generate a
          demographic psychographic analysis.
        </Typography>
      </div>
      <TableContainer component={Paper} className="popularProductsTable">
        <Table aria-label="square store customers table">
          <TableHead>
            <TableRow>
          ...
          <TableBody>
            {props.data.most_popular_items.map(
              (popularItem: PopularItem, index: number) => (
                <TableRow
                  key={index}
                  sx={{ "&:last-child td, &:last-child th": { border: 0 } }}
                >
                  ...
                  <TableCell align="right">
                    {popularItem.popular_age_bucket}
                  </TableCell>
                  <TableCell align="right">
                    {popularItem.total_quantity}
                  </TableCell>
                  <TableCell align="right">
                    ${popularItem.total_sales}
                  </TableCell>
                  <TableCell align="right">
                    {popularItem.catalog_object_id}
                  </TableCell>
                </TableRow>
              )
            )}
      ...
      <Typography paragraph>
        You can now generate a new product that is inspired by your top 3
        popular products and their demographic's psychographic analysis. <br />
...
function SubscriptionItemsAnalysisMessage(props: { data: any }) {
  return (
    <>
      ...
      <div style={{ marginBottom: 20 }}>
        <Typography paragraph>
          Your subscriptions with numbers sold
          <br />
          1. For each of them, count all the customers to figure out the most
          popular age bucket.
          <br />
          2. For the top subscription, for its customers we generate a
          demographic psychographic analysis on the top 3 customer age buckets.
        </Typography>
      </div>
  ...
  return (
    <div className={"message " + (role == "system" ? "system" : "user")}>
      ...
      <div className="message-body">
        ...
        {props.type === "popular-items-analysis" &&
          props.data &&
          props.generateProduct && (
            <PopularItemsAnalysisMessage
              data={props.data}
              generateProduct={props.generateProduct}
            />
          )}
